...
func main() {
	...
	// PhotoMetadata
	r.GET("/album", controllers.FindAlbum)
	r.POST("/album", controllers.CreateAlbum)
	r.GET("/album/:id", controllers.FindAlbumById)
	r.PUT("/album/:id", controllers.UpdateAlbumById)
	r.DELETE("/album/:id", controllers.DeleteAlbumById)
